...
struct ImGui_ImplGlfw_Data
{
    ...
    GLFWtouchfun            PrevUserCallbackTouch;
...
void ImGui_ImplGlfw_TouchCallback(GLFWwindow* window, int touch, int action, double x, double y)
{
    static int activeTouch = -1;
...
void ImGui_ImplGlfw_InstallCallbacks(GLFWwindow* window)
{
    ...
    bd->PrevUserCallbackTouch = glfwSetTouchCallback(window, ImGui_ImplGlfw_TouchCallback);
